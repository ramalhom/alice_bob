    ...
    case "list":
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <p>Alice envoie un message à Bob sur Internet sans cryptage.
                  <button type="button" class="btn btn-link btn-bigger" data-toggle="modal" data-target="#step1Modal">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p>Alice envoie un message à Bob sur Internet avec un cryptage symétrique.
                    <button type="button" class="btn btn-link btn-bigger" data-toggle="modal" data-target="#step2Modal">
                        <i class="fa fa-info-circle"></i>
                    </button>
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p>Alice envoie un message à Bob sur Internet avec un cryptage asymétrique.
                    <button type="button" class="btn btn-link btn-bigger" data-toggle="modal" data-target="#step3Modal">
                        <i class="fa fa-info-circle"></i>
                    </button>
                </p>
            </div>
